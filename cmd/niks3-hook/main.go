...
func printServeHelp() {
	...
	fmt.Fprintln(os.Stderr, "        SQLite database path (default: /var/lib/niks3/upload-queue.db)")
...
func runServe() error {
	...
	dbPath := fs.String("db-path", "/var/lib/niks3/upload-queue.db", "SQLite database path")
